  ...
  describe('.notEqual', function() {
    ...
    it('should supply a default message', function() {
      try {
        ...
        if ('fail' == e.message) throw e
        if ('Expected true not to equal true.' != e.message)
          throw new Error('fail')
      }
    })
  ...
  describe('.deepEqual', function() {
    ...
    it('should supply a default message', function() {
      try {
        ...
        if ('fail' == e.message) throw e
        if ('Expected ["a","b"] to deeply equal [1,2].' != e.message)
          throw new Error('fail')
      }
    })
  ...
  describe('.notDeepEqual', function() {
    ...
    it('should supply a default message', function() {
      try {
        ...
        if ('fail' == e.message) throw e
        if ('Expected ["a","b"] not to deeply equal ["a","b"].' != e.message)
          throw new Error('fail')
      }
    })
  ...
  describe('.strictEqual', function() {
    ...
    it('should supply a default message', function() {
      try {
        ...
        if ('fail' == e.message) throw e
        if ('Expected 1 to strictly equal "1".' != e.message)
          throw new Error('fail')
      }
    })
  ...
  describe('.notStrictEqual', function() {
    ...
    it('should supply a default message', function() {
      try {
        ...
        if ('fail' == e.message) throw e
        if ('Expected "1" not to strictly equal "1".' != e.message)
          throw new Error('fail')
      }
    })
    ...
    it('should respect a custom message', function() {
      try {
        assert.notStrictEqual('1', '1', 'message')
        throw new Error('fail')
      } catch (e) {
        if ('fail' == e.message) throw e
        if ('message' != e.message) throw new Error('fail')
